...
// Defines values for CreateEditResponseObject.
const (
	Edit CreateEditResponseObject = "edit"
)
...
// Defines values for CreateFineTuneRequestHyperparametersNEpochs0.
const (
	CreateFineTuneRequestHyperparametersNEpochs0Auto CreateFineTuneRequestHyperparametersNEpochs0 = "auto"
)
...
// Defines values for FineTuneObject.
const (
	FineTuneObjectFineTune FineTuneObject = "fine-tune"
)

// Defines values for FineTuneEventObject.
const (
...
// Defines values for ListFineTuneEventsResponseObject.
const (
	ListFineTuneEventsResponseObjectList ListFineTuneEventsResponseObject = "list"
)

// Defines values for ListFineTunesResponseObject.
const (
...
type CreateFineTuneRequest struct {
	...
	Hyperparameters *struct {
		...
		NEpochs *CreateFineTuneRequest_Hyperparameters_NEpochs `json:"n_epochs,omitempty"`
...
// CreateFineTuneRequestHyperparametersNEpochs0 defines model for CreateFineTuneRequest.Hyperparameters.NEpochs.0.
type CreateFineTuneRequestHyperparametersNEpochs0 string

// CreateFineTuneRequestHyperparametersNEpochs1 defines model for .
type CreateFineTuneRequestHyperparametersNEpochs1 = int

// CreateFineTuneRequest_Hyperparameters_NEpochs The number of epochs to train the model for. An epoch refers to one
// full cycle through the training dataset.
type CreateFineTuneRequest_Hyperparameters_NEpochs struct {
	union json.RawMessage
}
...
type CreateSpeechRequest struct {
	...
	// ResponseFormat The format to audio in. Supported formats are `mp3`, `opus`, `aac`, and `flac`.
...
// FineTuneEventObject defines model for FineTuneEvent.Object.
...
// ListFineTuneEventsResponseObject defines model for ListFineTuneEventsResponse.Object.
...
// ListFineTunesResponseObject defines model for ListFineTunesResponse.Object.
...
type ModifyAssistantRequest struct {
	...
	// FileIds A list of [File](/docs/api-reference/files) IDs attached to this assistant. There can be a maximum of 20 files attached to the assistant. Files are ordered by their creation date in ascending order. If a file was previosuly attached to the list but does not show up in the list, it will be deleted from the assistant.
	FileIds *[]string `json:"file_ids,omitempty"`
...
// AsCreateFineTuneRequestHyperparametersNEpochs0 returns the union data inside the CreateFineTuneRequest_Hyperparameters_NEpochs as a CreateFineTuneRequestHyperparametersNEpochs0
func (t CreateFineTuneRequest_Hyperparameters_NEpochs) AsCreateFineTuneRequestHyperparametersNEpochs0() (CreateFineTuneRequestHyperparametersNEpochs0, error) {
	var body CreateFineTuneRequestHyperparametersNEpochs0
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromCreateFineTuneRequestHyperparametersNEpochs0 overwrites any union data inside the CreateFineTuneRequest_Hyperparameters_NEpochs as the provided CreateFineTuneRequestHyperparametersNEpochs0
func (t *CreateFineTuneRequest_Hyperparameters_NEpochs) FromCreateFineTuneRequestHyperparametersNEpochs0(v CreateFineTuneRequestHyperparametersNEpochs0) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeCreateFineTuneRequestHyperparametersNEpochs0 performs a merge with any union data inside the CreateFineTuneRequest_Hyperparameters_NEpochs, using the provided CreateFineTuneRequestHyperparametersNEpochs0
func (t *CreateFineTuneRequest_Hyperparameters_NEpochs) MergeCreateFineTuneRequestHyperparametersNEpochs0(v CreateFineTuneRequestHyperparametersNEpochs0) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsCreateFineTuneRequestHyperparametersNEpochs1 returns the union data inside the CreateFineTuneRequest_Hyperparameters_NEpochs as a CreateFineTuneRequestHyperparametersNEpochs1
func (t CreateFineTuneRequest_Hyperparameters_NEpochs) AsCreateFineTuneRequestHyperparametersNEpochs1() (CreateFineTuneRequestHyperparametersNEpochs1, error) {
	var body CreateFineTuneRequestHyperparametersNEpochs1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromCreateFineTuneRequestHyperparametersNEpochs1 overwrites any union data inside the CreateFineTuneRequest_Hyperparameters_NEpochs as the provided CreateFineTuneRequestHyperparametersNEpochs1
func (t *CreateFineTuneRequest_Hyperparameters_NEpochs) FromCreateFineTuneRequestHyperparametersNEpochs1(v CreateFineTuneRequestHyperparametersNEpochs1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeCreateFineTuneRequestHyperparametersNEpochs1 performs a merge with any union data inside the CreateFineTuneRequest_Hyperparameters_NEpochs, using the provided CreateFineTuneRequestHyperparametersNEpochs1
func (t *CreateFineTuneRequest_Hyperparameters_NEpochs) MergeCreateFineTuneRequestHyperparametersNEpochs1(v CreateFineTuneRequestHyperparametersNEpochs1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t CreateFineTuneRequest_Hyperparameters_NEpochs) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *CreateFineTuneRequest_Hyperparameters_NEpochs) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
